...
<body class="overflow-hidden">
    ...
    <main class="container-fluid">
        {{-- Curosel Appartamenti SPONSORIZZATI --}}
        <div class="row py-4 ">
                ...
                <div id="carouselExample" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('assets/Logo.svg') }}" class="d-block" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="..." class="d-block w-100" alt="Seconda Immagine sponsorizzata">
                        </div>
                        <div class="carousel-item">
                            <img src="..." class="d-block w-100" alt="Terza immagine sponsorizzata">
                        </div>
                    </div>
            ...
            <div class="col-10 m-auto">
                ...
                @foreach ($apartments as $elem)
                    <div class="card" style="width: 18rem;">
                        {{-- Cover --}}
                        <img src="{{ $elem->cover_image }}" class="card-img-top" alt="cover_image">
